"""Init migration, onlu users and groups

Revision ID: d79896ecec05
Revises: 
Create Date: 2025-06-11 18:09:57.529133
...
def upgrade() -> None:
    ...
    sa.UniqueConstraint('description', name=op.f('uq_tasks_description')),
    ...
    sa.UniqueConstraint('description', name=op.f('uq_subtasks_description')),
